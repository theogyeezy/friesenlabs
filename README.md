...
| 🟙 **Pending** | friesenlabs.com DNS + TLS (NS cutover **DONE**, wildcard ACM **ISSUED**; stale us-east-2 Amplify app evicted off the domain, apex/www re-associated to uplift-web) | domain association propagating | ALB TLS cutover (RUNBOOK sequence, now unblocked — hourly sweep auto-runs it) |
